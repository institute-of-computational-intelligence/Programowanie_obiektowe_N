...
public class Apikacja_Mateusza {

    public static void main(String[] args) {
        import java.text.ParseException;
import java.text.SimpleDateFormat;
public class PO_N_Lab2 { // uwaga nazwa klasy może się różnić
...
Barcelona", 10);
 ...
 Player footballer = new HandballPlayer("Piotr", "Kos", sdf.parse("14/09/1984"), "striker", "FC
Politechnika", 2);
 student.details();
 footballer.details();
