...
public class Lab2 {
 ...
 student.details();
    ...
    class Student extends Person {
        ...
        public Student(String michał, String kot, Date parse, int i, int i0, int i1) {
        }

        void addGrade(String po, double d, Date parse) {
    ...
    void deleteGrade(String awww, double d, Date parse) {
        throw new UnsupportedOperationException("Not supported yet."); //To change body of generated methods, choose Tools | Templates.
    }

    void deleteGrades(String awww) {
        throw new UnsupportedOperationException("Not supported yet."); //To change body of generated methods, choose Tools | Templates.
    }
